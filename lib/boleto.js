...
Boleto.prototype._calculate = function () {
  ...
  this['linha_digitavel'] = this.bank.linhaDigitavel(this['barcode_data'], this['codigo_barras'])
}
...
Boleto.prototype.renderHTML = function (callback) {
  ...
  console.log('node-boleto linha_digitavel:', renderOptions['boleto']['linha_digitavel']);
  renderOptions['boleto']['linha_digitavel_hash'] = '1006808146'
  console.log('node-boleto hash mock:', '1006808146');
  console.log('node-boleto linha_digitavel_hash:', renderOptions['boleto']['linha_digitavel_hash']);
